...
################################################################################
## Form generated from reading UI file 'ordersnFKese.ui'
##
...
"")
        ...
        self.frame_Period = QFrame(self.frame_dates)
        self.frame_Period.setObjectName(u"frame_Period")
        self.frame_Period.setMinimumSize(QSize(150, 0))
        self.frame_Period.setMaximumSize(QSize(16777215, 16777215))
        self.frame_Period.setStyleSheet(u"#frame_Period {\n"
"	border-width: 1;\n"
"	border-radius: 3;\n"
"	border-style: solid;\n"
"	border-color: #bd93f9;\n"
"}")
        self.frame_Period.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_Period.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_7 = QVBoxLayout(self.frame_Period)
        self.verticalLayout_7.setSpacing(0)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.verticalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.label_6 = QLabel(self.frame_Period)
        ...
        self.frame_7 = QFrame(self.frame_Period)
        ...
        self.line_period_year = QComboBox(self.frame_8)
        self.line_period_year.setObjectName(u"line_period_year")
        self.line_period_year.setMinimumSize(QSize(0, 25))
        self.line_period_year.setMaximumSize(QSize(16777215, 25))

        self.verticalLayout_2.addWidget(self.line_period_year)
        ...
        self.line_period_qtr = QComboBox(self.frame_9)
        self.line_period_qtr.setObjectName(u"line_period_qtr")
        self.line_period_qtr.setMinimumSize(QSize(0, 25))
        self.line_period_qtr.setMaximumSize(QSize(16777215, 25))

        self.verticalLayout_3.addWidget(self.line_period_qtr)
        ...
        self.line_period_mnth = QComboBox(self.frame_10)
        self.line_period_mnth.setObjectName(u"line_period_mnth")
        self.line_period_mnth.setMinimumSize(QSize(0, 25))
        self.line_period_mnth.setMaximumSize(QSize(16777215, 25))

        self.verticalLayout_6.addWidget(self.line_period_mnth)
        ...
        self.frame_ord_date = QFrame(self.frame_dates)
        self.frame_ord_date.setObjectName(u"frame_ord_date")
        self.frame_ord_date.setMinimumSize(QSize(150, 0))
        self.frame_ord_date.setMaximumSize(QSize(16777215, 16777215))
        self.frame_ord_date.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_ord_date.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_8 = QVBoxLayout(self.frame_ord_date)
        self.verticalLayout_8.setSpacing(0)
        self.verticalLayout_8.setObjectName(u"verticalLayout_8")
        self.verticalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.label_7 = QLabel(self.frame_ord_date)
        ...
        self.frame_11 = QFrame(self.frame_ord_date)
        ...
        self.line_ord_year = QComboBox(self.frame_12)
        self.line_ord_year.setObjectName(u"line_ord_year")
        self.line_ord_year.setMinimumSize(QSize(0, 25))
        self.line_ord_year.setMaximumSize(QSize(16777215, 25))

        self.verticalLayout_9.addWidget(self.line_ord_year)
        ...
        self.line_ord_qtr = QComboBox(self.frame_13)
        self.line_ord_qtr.setObjectName(u"line_ord_qtr")
        self.line_ord_qtr.setMinimumSize(QSize(0, 25))
        self.line_ord_qtr.setMaximumSize(QSize(16777215, 25))

        self.verticalLayout_10.addWidget(self.line_ord_qtr)
        ...
        self.line_ord_mnth = QComboBox(self.frame_14)
        self.line_ord_mnth.setObjectName(u"line_ord_mnth")
        self.line_ord_mnth.setMinimumSize(QSize(0, 25))
        self.line_ord_mnth.setMaximumSize(QSize(16777215, 25))

        self.verticalLayout_11.addWidget(self.line_ord_mnth)
        ...
        self.horizontalLayout_2.addWidget(self.frame_ord_date)
        ...
        self.label_orders_File = QLabel(self.frame_4)
        self.label_orders_File.setObjectName(u"label_orders_File")
        self.label_orders_File.setMinimumSize(QSize(0, 30))
        self.label_orders_File.setMaximumSize(QSize(16777215, 30))
        self.label_orders_File.setStyleSheet(u"background-color: #6272a4;\n"
"border-radius: 5px;\n"
"border: 2px solid #6272a4;\n"
"padding-left: 10px;\n"
"selection-color: rgb(255, 255, 255);\n"
...
"color: #f8f8f2;")
        ...
        self.horizontalLayout_5.addWidget(self.label_orders_File)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"\u0417\u0430\u043a\u0430\u0437\u044b", None))
        self.label_6.setText(QCoreApplication.translate("Form", u"\u041f\u0435\u0440\u0438\u043e\u0434 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044f \u0437\u0430\u043a\u0430\u0437\u0430", None))
        ...
        self.label_7.setText(QCoreApplication.translate("Form", u"\u0414\u0430\u0442\u0430 \u0437\u0430\u043a\u0430\u0437\u0430", None))
        ...
        self.label_orders_File.setText(QCoreApplication.translate("Form", u"File Path", None))
