...
################################################################################
## Form generated from reading UI file 'productsXLlCkM.ui'
##
...
"")
        ...
        self.line_Artical.setMinimumSize(QSize(0, 22))
        self.line_Artical.setMaximumSize(QSize(16777215, 22))
        ...
        self.line_Brand.setMinimumSize(QSize(0, 22))
        self.line_Brand.setMaximumSize(QSize(16777215, 22))
        ...
        self.line_Prod_Fam.setMinimumSize(QSize(0, 22))
        self.line_Prod_Fam.setMaximumSize(QSize(16777215, 22))
        ...
        self.frame_Update.setMinimumSize(QSize(0, 0))
        ...
        self.frame_5.setMinimumSize(QSize(120, 0))
