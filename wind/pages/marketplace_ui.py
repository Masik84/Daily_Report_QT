...
################################################################################
## Form generated from reading UI file 'marketplaceWSfaXR.ui'
##
...
"")
        ...
        self.line_marketPl.setMinimumSize(QSize(0, 22))
        self.line_marketPl.setMaximumSize(QSize(16777215, 22))
        ...
        self.line_Date.setMinimumSize(QSize(0, 22))
        self.line_Date.setMaximumSize(QSize(16777215, 22))
        ...
        self.line_pack.setMinimumSize(QSize(0, 22))
        self.line_pack.setMaximumSize(QSize(16777215, 22))
...
"}")
        ...
        self.horizontalLayout_10.addWidget(self.label_msg)
