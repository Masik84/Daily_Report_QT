...
################################################################################
## Form generated from reading UI file 'supplieruTGkCv.ui'
##
...
"")
        ...
        self.frame_suppl_file.setMinimumSize(QSize(0, 0))
        self.frame_suppl_file.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.label_msg = QLabel(self.frame_suppl_file)
