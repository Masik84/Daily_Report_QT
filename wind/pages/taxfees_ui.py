...
################################################################################
## Form generated from reading UI file 'taxfeesGcubnt.ui'
##
...
"")
        ...
        self.line_taxfee_type.setMinimumSize(QSize(0, 22))
        self.line_taxfee_type.setMaximumSize(QSize(16777215, 22))
        ...
        self.lineEdit_TNVED.setMinimumSize(QSize(0, 22))
        self.lineEdit_TNVED.setMaximumSize(QSize(16777215, 22))
        font2 = QFont()
