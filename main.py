...
from pages_functions.delivery import DeliveryPage
from pages_functions.commission import CommissionPage
...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        self.btn_delivery = self.ui.btn_CustDelivery
        self.btn_commis = self.ui.btn_Comission
        ...
        self.menu_btns_list = {
            ...
            self.btn_delivery: DeliveryPage(),
            self.btn_commis: CommissionPage(),
        ...
        self.btn_commis.clicked.connect(self.show_selected_window)
