    ...
    def _upload_fees_data(self, file_path):
        ...
        try:
            ...
            column_map = {
                ...
                "Месяц": "month_id", 
                "Акциз": "Excise",
                "Тамож. оформление": "Customs_clearance", 
                "Комиссия банка": "Bank_commission",
                "Эко сбор ст-ть": "Eco_fee_amount", 
                "Эко сбор норм": "Eco_fee_standard",
                "Транспорт (перемещ), л": "Transportation", 
                "Хранение, л": "Storage",
                "Ст-ть Денег": "Money_cost", 
                "Доп% денег": "Additional_money_percent",
                'Марка': 'Lable', 
                "Оклейка остатков": 'Okleyka',
                'Хранение Тебойл': 'Storage_Teboil', 
                'Трансп Тебойл': 'Transport_Teboil'
            }
        ...
        try:
            ...
            for row in fees:
                result.append({
                    ...
                    'Хранение Тебойл': row.Storage_Teboil,
                    'Трансп Тебойл': row.Transport_Teboil
                })
